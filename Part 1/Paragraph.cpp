...
ofstream& operator<<(ofstream& Fout, Paragraph& obj)
{
    ...
    /*Fout << obj.Count_Words_Sen() << endl;
    Fout << obj.Count_Word_Char() << endl;*/
    int word = 0;
    int extra = 0;
    int num = 1;
    int count = 0;
...
int Paragraph::Count_Total_Words()
{
    int count = 0;
    for (int i = 0; i < this->s1; i++) {
        for (int j = 0; j < this->s2; j++) {
...
void Paragraph::Count_Word_Char()
{
    int word = 0;
    int extra = 0;
    int num = 1;
...
void Paragraph::Count_Words_Sen()
{
    int num = 0;
    int extra = 0;
    int count = 1;
